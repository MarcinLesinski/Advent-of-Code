package adventOdCode.puzzles.day6
...
class GroupAnswersEveryoneVoteTests {
    ...
    companion object {
        ...
        fun inputsSource(): Stream<Arguments> {
            return Stream.of(
                ...
                Arguments.of(listOf("a", "b", "c"), 0),
                Arguments.of(listOf("ab", "ac"), 1),
    ...
    fun `count question to which anyone answered yes`(input: List<String>, expected: Int) {
        ...
        val actual = countAnswersWhichEveryoneVoted(input)
